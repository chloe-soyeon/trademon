...
public class MailController {
    ...
    public MsgDTO sendMail(HttpServletRequest request, ModelMap model) throws Exception {
        ...
        // 웹 URL로부터 전달받는 값들
        String toMail = kr.trademon.util.CmmUtil.nvl(request.getParameter("toMail")); // 받는사람
        String title = kr.trademon.util.CmmUtil.nvl(request.getParameter("title")); // 제목
        String contents = kr.trademon.util.CmmUtil.nvl(request.getParameter("contents")); // 내용
