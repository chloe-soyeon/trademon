...
public class MailService implements IMailService {
    ...
    public int doSendMail(MailDTO pDTO) {
        ...
        String toMail = kr.trademon.util.CmmUtil.nvl(pDTO.getToMail()); // 받는사람
        String title = kr.trademon.util.CmmUtil.nvl(pDTO.getTitle()); // 메일제목
        String contents = kr.trademon.util.CmmUtil.nvl(pDTO.getContents()); // 메일제목
        ...
        try {
            ...
            // messageHelper.setText(contents); // 메일 내용 원래 버젼
